...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void buttonConnect_Click(object sender, EventArgs e)
        {
            ...
            if (textBoxName.Text == "PCPartPickerG10")
            {
                ...
                switch(repName)
                {
                    ...
                    case 4:
                        {
                            textBoxName.Text = "Sanjeed";
                            break;
                        }

                    case 5:
                        {
                            textBoxName.Text = "Brenda";
                            break;
                        }
        ...
        private void listBoxChat_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            {
                textBoxName.Focus();
                MessageBox.Show("Please enter your name and press the connect button.");
            ...
            listBoxChat.SelectedIndex = -1;
                ...
                for (int n = listBoxChat.Items.Count - 1; n >= 0; --n)
                {
                    ...
                    if (joined == true)
                    {
                        if (listBoxChat.Items[n].ToString().Contains("Joined") && !listBoxChat.Items[n].ToString().Contains("Emma") && !listBoxChat.Items[n].ToString().Contains("Bob") && !listBoxChat.Items[n].ToString().Contains("Jim") || listBoxChat.Items[n].ToString().ToLower().Contains("Hello".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Hey".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Hi".ToLower()))
                        {
                            ...
                            switch (repName)
                            {
                                ...
                                case 4:
                                    outStream = System.Text.Encoding.ASCII.GetBytes("Hello, my name is Sanjeed, I will be your PC Part Picker \r\nassistant today govener." + "$");
                                    serverStream.Write(outStream, 0, outStream.Length);
                                    serverStream.Flush();
                                    break;

                                case 5:
                                    outStream = System.Text.Encoding.ASCII.GetBytes("Hello, my name is Brenda, I will be your PC Part Picker \r\nassistant today." + "$");
                                    serverStream.Write(outStream, 0, outStream.Length);
                                    serverStream.Flush();
                                    break;
                    ...
                    if (usage == true)
                    {
                        ...
                        serverStream.Flush();
                        Thread.Sleep(5000);
                        outStream = System.Text.Encoding.ASCII.GetBytes("To start with, can I ask you what you will be primarily using \r\nthe PC for?\r\n- Gaming\r\n- Web and Word\r\n- Video Editing\r\n- Home Theater\r\n- All rounder" + "$");
                        serverStream.Write(outStream, 0, outStream.Length);
                        serverStream.Flush();
                    ...
                    if (reply1 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Gaming".ToLower()))
                            {
                                ...
                                serverStream.Flush();
                                Thread.Sleep(5000);
                                outStream = System.Text.Encoding.ASCII.GetBytes("Right'o. What budget do you have for your gaming PC? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Middle (500.00 - 800.00)\r\n- High (800.00 - 1500.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                pcParts = "gaming";
                                reply1 = false;
                    ...
                    if (reply1 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Web and Word".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Web".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Word".ToLower()))
                            {
                                ...
                                serverStream.Flush();
                                Thread.Sleep(5000);
                                outStream = System.Text.Encoding.ASCII.GetBytes("Right'o. What budget do you have for your Web and Word PC? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Middle (500.00 - 800.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                    ...
                    if (reply1 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            ...
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Video Editing".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Video".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Editing".ToLower()))
                            {
                                ...
                                serverStream.Flush();
                                Thread.Sleep(5000);
                                outStream = System.Text.Encoding.ASCII.GetBytes("Right'o. What budget do you have for your video editing PC? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Middle (500.00 - 800.00)\r\n- High (800.00 - 1500.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                    ...
                    if (reply1 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Home Theater".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Home".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Theater".ToLower()))
                            {
                                ...
                                serverStream.Flush();
                                Thread.Sleep(5000);
                                outStream = System.Text.Encoding.ASCII.GetBytes("Right'o. What budget do you have for your home theater pc? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Middle (500.00 - 800.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                    ...
                    if (reply1 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("All Rounder".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("All".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Rounder".ToLower()))
                            {
                                ...
                                serverStream.Flush();
                                Thread.Sleep(5000);
                                outStream = System.Text.Encoding.ASCII.GetBytes("Right'o. What budget do you have for your all rounder pc? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Middle (500.00 - 800.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                pcParts = "all rounder";
                                reply1 = false;
                    ...
                    if (reply2 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Low".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("300".ToLower()))
                            {
                                ...
                                serverStream.Flush();
                                Thread.Sleep(5000);
                                outStream = System.Text.Encoding.ASCII.GetBytes("Ok, which of these do you prioritise: \r\n-speed or \r\n-storage?" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                budgetS = "low";
                                reply2 = false;
                        ...
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (pcParts == "video editing" || pcParts == "gaming")
                            {
                                if (listBoxChat.Items[n].ToString().ToLower().Contains("Suggest".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Suggestion".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Think".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("recommend".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("What Would".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("choose".ToLower()))
                                {
                                    ...
                                    serverStream.Flush();
                                    Thread.Sleep(3000);
                                    outStream = System.Text.Encoding.ASCII.GetBytes("Thats great\r\nplease give me a moment to gather your pc parts using the info you have provided me." + "$");
                                    serverStream.Write(outStream, 0, outStream.Length);
                                    serverStream.Flush();
                                    caseS = "not";
                    ...
                    if (reply4 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            ...
                            if (reply4 == false && finish == true)
                            {
                                ...
                                serverStream.Flush();
                                Thread.Sleep(5000);
                                outStream = System.Text.Encoding.ASCII.GetBytes("Thanks for using PC Part Picker.\r\n I hope I have been some help in the creation of your PC. Please leave any feedback on this chat." + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                finish = false;
                            }
