        ...
        private void listBoxChatChanged()
        {
            ...
            if (aiActivate == true)
            {
                ...
                for (int n = listBoxChat.Items.Count - 1; n >= 0; --n)
                {
                    if (joined == true)
                    {
                        if (listBoxChat.Items[n].ToString().Contains("Joined") && !listBoxChat.Items[n].ToString().Contains("PCPartPicker") || listBoxChat.Items[n].ToString().ToLower().Contains("Hello".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Hey".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Hi".ToLower()))
                        {
                            Thread.Sleep(5000);
                            ...
                            {
                                case 0:
                                    byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Hello, my name is Bob, i will be your PC Part Picker \r\nassistant today." + "$");
                                    serverStream.Write(outStream, 0, outStream.Length);
                                    serverStream.Flush();
                                    break;
                    ...
                    {
                        Thread.Sleep(5000);
                        byte[] outStream = System.Text.Encoding.ASCII.GetBytes("To start with can i ask you, what will be primarily using \r\nthe computer for?\r\n- Gaming\r\n- Web and Word\r\n- Video Editing\r\n- Home Theater\r\n- All rounder" + "$");
                        serverStream.Write(outStream, 0, outStream.Length);
                        serverStream.Flush();
                    ...
                    if (reply1 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            ...
                            {
                                Thread.Sleep(3000);
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Right'o, and what budget do you have for your gaming pc? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Medium (500.00 - 800.00)\r\n- High (800.00 - 1500.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                pcParts = "gaming";
                                reply1 = false;
                            ...
                            {
                                Thread.Sleep(3000);
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Right'o, and what budget do you have for your Web and Word pc? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Medium (500.00 - 800.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                            ...
                            {
                                Thread.Sleep(3000);
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Right'o, and what budget do you have for your Video Editing pc? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Medium (500.00 - 800.00)\r\n- High (800.00 - 1500.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                            ...
                            {
                                Thread.Sleep(3000);
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Right'o, and what budget do you have for your Home Theater pc? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Medium (500.00 - 800.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                            ...
                            {
                                Thread.Sleep(3000);
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Right'o, and what budget do you have for your All Rounder pc? \r\n(GBP)\r\n- Low (300.00 - 500.00)\r\n- Medium (500.00 - 800.00)" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                pcParts = "all rounder";
                                reply1 = false;
                    ...
                    if (reply2 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            ...
                            {
                                Thread.Sleep(3000);
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Ok, do you prefer your computer to be -FAST \r\nor have a large amount of -STORAGE?" + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                budgetS = "low";
                                reply2 = false;
                    ...
                    if (reply3 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (pcParts == "video editing" || pcParts == "gaming")
                            {
                                ...
                                {
                                    Thread.Sleep(3000);                                    
                                    byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Fantastic, finally how important is it that the computer does not take up alot of space\r\n- Very important \r\n- Not at all" + "$");
                                    serverStream.Write(outStream, 0, outStream.Length);
                                    serverStream.Flush();
                    ...
                    if (reply4 == true)
                    {
                        if (!listBoxChat.Items[n].ToString().ToLower().Contains("-"))
                        {
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Vey Important".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Very".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Important".ToLower()))
                            {
                                Thread.Sleep(3000);                               
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Thats great, please give me a moment to gather\r\n your pc parts using the info you have provided me." + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                                serverStream.Flush();
                                caseS = "very";
                            ...
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Not at All".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Not".ToLower()))
                            {
                                Thread.Sleep(3000);                               
                                byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Thats great, please give me a moment to gather\r\n your pc parts using the info you have provided me." + "$");
                                serverStream.Write(outStream, 0, outStream.Length);
                            ...
                            if (listBoxChat.Items[n].ToString().ToLower().Contains("Somewhat".ToLower()) || listBoxChat.Items[n].ToString().ToLower().Contains("Some".ToLower()))
                            {
                        ...
                        {
                            Thread.Sleep(5000);
                            byte[] outStream = System.Text.Encoding.ASCII.GetBytes("Thanks for using PC PART PICKER, I hope i have been some help in the creation of your pc.Please leave any feedback on this chat. farewell!" + "$");
                            serverStream.Write(outStream, 0, outStream.Length);
                            serverStream.Flush();
                            finish = false;
                        }
